...
function IWagendas_tables() {
    ...
    $table['IWagendas_column'] = array('aid' => 'aid',
                                       'usuari' => 'usuari',
                                       'data' => 'data',
                                       'completa' => 'completa',
                                       'c1' => 'c1',
                                       ...
                                       'data1' => 'data1');
    $table['IWagendas_column_def'] = array('aid' => "I NOTNULL AUTO PRIMARY",
    ...
    $table['IWagendas_definition_column'] = array('daid' => 'daid',
                                                  ...
                                                  'gColor' => 'gColor');
    $table['IWagendas_definition_column_def'] = array('daid' => "I NOTNULL AUTO PRIMARY",
    ...
    $table['IWagendas_subs_column'] = array('said' => 'said',
                                            'daid' => 'daid',
                                            'uid' => 'uid',
                                            'donadabaixa' => 'donadabaixa',
                                            'llistat' => 'llistat',
                                            'avisos' => 'avisos');
    $table['IWagendas_subs_column_def'] = array('said' => "I NOTNULL AUTO PRIMARY",
                                                'daid' => "I NOTNULL DEFAULT '0'",
